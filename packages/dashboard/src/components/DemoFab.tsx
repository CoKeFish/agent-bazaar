...
const DEMO_LINKS: DemoLink[] = [
  ...
  { href: "https://www.npmjs.com/package/agent-bazaar-mcp", labelKey: "demo_fab.links.mcp" },
  { href: "https://www.npmjs.com/package/@agent-bazaar/sdk", labelKey: "demo_fab.links.sdk" },
];

const FAB_SIZE = 52;
const MARGIN = 8;
const POS_KEY = "agent-bazaar:demo-fab-pos";
