...
const MCP_URL =
  ...
  "https://agent-bazaar-api.rodion.com.co/mcp";

/** Base del gateway (sin /mcp) para el adaptador stdio `agent-bazaar-mcp` (AGENT_BAZAAR_URL). */
...
const INSTALL_CONFIG = JSON.stringify(
  {
    mcpServers: {
      "agent-bazaar": {
        ...
        env: { AGENT_BAZAAR_URL: GATEWAY_BASE },
      },
    },
  },
  null,
...
/**
 * Panel para empezar a usar Agent Bazaar: conectar por web (Claude/ChatGPT) o instalar
